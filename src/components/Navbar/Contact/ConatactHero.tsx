    ...
    <Box className="hero">
      <Container>
        ...
        <Box className="description">
          Our support team is available <span className="contact-span">Monday to Friday, 9 AM - 5 PM (WAT)</span> to assist with product inquiries, partnerships, and technical support.
